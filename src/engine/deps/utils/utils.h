...
char * ui32_to_str(i32 i);
char * uf64_to_str(f64 num);
...
///     txt_file_write: Writes a string to a given filepath 
////////////////////////////////////////
////////////////////////////////////////
*/
...
#define CHT_DEF(tn, name) \
    ...
    typedef struct { uht_##name##_pair_t ** e; sz_t used; sz_t sz; } uht_##name##_t; \
...
typedef struct {
    ...
    uv2_t vel;       
    uv2_t acc;
    uv2_t extra_momentum; // y_momentum and stuff
    ...
    movement_t h_move; // -1 : left, 1 : right 
    movement_t v_move; // -1 : top, 1 : bottom 

    coll_t h_coll; // -1 : left collision, 1 : right collision
    coll_t v_coll; // -1 : top collision, 1 : bottom collision
